...
namespace gui
{
	...
	typedef std::pair<sf::String, std::pair<sf::Color, sf::Text::Style>>(ColoredString);
	...
	private:		
		...
		friend ColoredText bind(sf::String&& string, const sf::Color& color, const sf::Text::Style style);
		...
		friend ColoredText operator+(const std::function<ColoredText()>& func1, const std::function<ColoredText()>& func2);
		friend ColoredText operator+(std::function<ColoredText()>&& func1, ColoredText&& string);
		friend ColoredText operator+(std::function<ColoredText()>&& func1, const ColoredText& string);
		friend ColoredText operator+(const std::function<ColoredText()>& func1, ColoredText&& string);
		friend ColoredText operator+(const std::function<ColoredText()>& func1, const ColoredText& string);
	};
